...
print("train error with pruning: " + str(1-clf.score(trainX, trainY)))
print("test error with pruning: " + str(1-clf.score(testX, testY)))
print("tree depth with pruning : " + str(clf.tree_.max_depth))
scores = cross_val_score(clf, X, Y, cv=5)
print("%0.2f accuracy with a standard deviation of %0.2f when used cross validation with pruning" % (1-scores.mean(), scores.std()))
