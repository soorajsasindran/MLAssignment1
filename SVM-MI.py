...
for column in trainY:
    print("train score for " + column + " :" + str(accuracy_score(predTrainY, trainY[column])))
    print("test score for " + column + " :" + str(accuracy_score(predY, testY[column])))
...
print("")
for column in trainY:
    print("train error for " + column + " :" + str(1-accuracy_score(predTrainY, trainY[column])))
    print("test error for " + column + " :" + str(1-accuracy_score(predY, testY[column])))
